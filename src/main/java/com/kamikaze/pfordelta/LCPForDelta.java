 ...
 * The original Simple16 algorithm can also be found in the above literature.
 * <p/>
 * This implementation overcomes the problem that Simple16 cannot deal with >2^28 numbers.
 * <p/>
 * This implementation is almost same as PForDelta in the same package, except that it is tuned especially for Lucene-4.0 Codec to achieve
...
public class LCPForDelta {
    ...
    public static void decompressOneBlockWithSizeWithIntBuffer(final int[] decompBlock, final IntBuffer inBlock, final int blockSize, final int[] expPosBuffer, final int[] expHighBitsBuffer, final int inBlockLen) {
    ...
    public static int decompressBBitSlotsWithHardCodes(final int[] outDecompSlots, final int[] inCompBlock, final int blockSize, final int bits) {
        int compressedBitSize = 0;
    ...
    public static int decompressBBitSlotsWithHardCodesWithIntBuffer(final int[] outDecompSlots, final IntBuffer inCompBlock, final int blockSize, final int bits) {
    ...
    public static void decompressBlockByS16WithIntBuffer(final int[] outDecompBlock, final IntBuffer inCompBlock, final int blockSize) {
        int num, outOffset = 0, numLeft;
        for (numLeft = blockSize; numLeft > 0; numLeft -= num) {
    ...
    public static void decompressBlockByS16WithIntBufferIntegrated(final int[] outDecompBlock, final IntBuffer inCompBlock, final int blockSize, int[] expPosBuffer, int oribits) {
        int num, outOffset = 0, numLeft;
        for (numLeft = blockSize; numLeft > 0; numLeft -= num) {
